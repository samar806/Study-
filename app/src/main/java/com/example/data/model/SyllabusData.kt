    ...
    val syllabus: Map<String, Map<String, List<String>>> = mapOf(
        ...
        "Class 1" to mapOf(
            "Mathematics" to listOf(
                "Shapes and Space", "Numbers from 1 to 9", "Addition", "Subtraction",
                "Numbers from 10 to 20", "Time", "Measurement", "Numbers from 21 to 50",
                "Data Handling", "Patterns", "Numbers from 51 to 100", "Money"
            ),
            "EVS" to listOf(
                "Myself and My Family", "Plants Around Us", "Animals Around Us",
                "Our Body", "Good Habits", "Food We Eat", "Water", "Our Home",
                "Air Around Us", "Days and Seasons"
            ),
            "English" to listOf(
                "Three Little Pigs", "A Happy Child", "After a Bath", "One Little Kitten",
                "Lalu and Peelu", "Mittu and the Yellow Mango", "Merry Go Round",
                "Circle", "If I Were an Apple", "A Kite", "Sundari", "The Tiger and the Mosquito"
            )
        ),
        "Class 2" to mapOf(
            "Mathematics" to listOf(
                "Numbers up to 100", "Addition and Subtraction", "Shapes and Patterns",
                "Time", "Money", "Numbers up to 1000", "Measurement of Length",
                "Multiplication", "Division (Sharing and Grouping)", "Data Handling"
            ),
            "EVS" to listOf(
                "My Family", "Our Helpers", "Food and Nutrition", "Plants Around Us",
                "Animals and Their Homes", "Keeping Clean", "Water Sources", "Weather and Seasons",
                "Our Neighbourhood", "Safety Rules"
            ),
            "English" to listOf(
                "First Day at School", "I Am Lucky", "Wind and the Sun", "Rain",
                "Storm in the Garden", "Zoo Manners", "Funny Bunny", "Mr. Nobody",
                "Curlylocks and the Three Bears", "On My Blackboard I Can Draw"
            )
        ),
        "Class 3" to mapOf(
            "Mathematics" to listOf(
                ...
                "How Many Times?", "Play with Patterns", "Jugs and Mugs", "Can We Share?", "Smart Charts"
            ),
            "EVS" to listOf(
                "Poonam's Kaksha", "Sharing our Feelings", "The Story of Food", "Flying High",
                "Rock with Me", "Families Can Be Different", "Making Pots", "Games We Play",
                "Here Comes a Letter", "Water O' Water", "Our Friends – Animals", "Drop by Drop", "Web of Life"
            ),
            "English" to listOf(
                "Good Morning", "The Magic Garden", "Bird Talk", "Nina and the Baby Sparrows",
                "Little by Little", "Badal and the Giant", "Trains", "The Yellow Butterfly",
                "The Great Stone Face – I", "The Great Stone Face – II", "I Know a Girl", "The Enormous Turnip"
            )
        ),
        "Class 4" to mapOf(
            "Mathematics" to listOf(
            ...
            "EVS" to listOf(
                ...
                "A River's Tale", "Basva's Farm", "From Market to Home", "A Busy Month", "Nandita in Mumbai",
                "A Different Kind of a School", "Reaching Airport"
            ),
            "English" to listOf(
                ...
                "Helen Keller", "The Donkey", "Books"
            )
        ),
        "Class 5" to mapOf(
            "Mathematics" to listOf(
                "The Fish Tale", "Shapes and Angles", "How Many Squares?", "Parts and Whole",
            ...
            "EVS" to listOf(
                ...
                "A Shelter So High", "When the Earth Shook", "Blood and Bone", "Who Will Do This Work?",
            ...
            "English" to listOf(
                ...
                "Robinson Crusoe Discovers a Footprint", "Crying", "My Elder Brother",
